...
```
$ docker image tag catalog cr4zy5h4rk/catalog-service
$ docker push cr4zy5h4rk/catalog-service
$ docker image tag customer cr4zy5h4rk/customer-service
$ docker push cr4zy5h4rk/customer-service
$ docker image tag gateway cr4zy5h4rk/gateway-service
$ docker push cr4zy5h4rk/gateway-service
$ docker image tag order cr4zy5h4rk/order-service
$ docker push cr4zy5h4rk/order-service
```
