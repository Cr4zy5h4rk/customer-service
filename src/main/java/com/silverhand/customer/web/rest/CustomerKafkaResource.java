...
import com.silverhand.customer.broker.KafkaConsumer;
...
public class CustomerKafkaResource {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(CustomerKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public CustomerKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
