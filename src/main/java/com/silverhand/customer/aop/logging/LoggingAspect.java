package com.silverhand.customer.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        """
        within(com.silverhand.customer.repository..*)
        || within(com.silverhand.customer.service..*)
        || within(com.silverhand.customer.web.rest..*)
        """
    )
